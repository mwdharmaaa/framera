...
export const TEMPLATE_SAMPLES = {
  ...
  astral_koi: {
    src: 'assets/user_samples/photo_tide_pool.jpg',
  ...
  tokyo_brutalist: {
    src: 'assets/user_samples/photo_sea_stones.jpg',
    caption: 'TOKYO',
  ...
  ai_vision: {
    src: 'assets/user_samples/photo_hill_coast.jpg',
  ...
  eyes_trend: {
    src: 'assets/user_samples/photo_green_foliage.jpg',
    caption: 'EYES TREND',
    subtitle: 'VIRAL DOODLE EDITION',
    date: '2026 // VOL.01'
  },
  final_girl: {
    src: 'assets/user_samples/photo_red_rose.jpg',
  ...
  imessage_cascade: {
    ...
    photos: [
      'assets/user_samples/photo_sunset_pink.jpg',
      'assets/user_samples/photo_cyan_sky.jpg',
      'assets/user_samples/photo_sweet_potato.jpg'
    ],
