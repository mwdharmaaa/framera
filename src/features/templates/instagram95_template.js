/**
 * Retro Windows 95 Instagram Application Window Template.
 * Features beveled Win95 UI chrome, active blue titlebar, classic menus,
 * CRT scanline overlay, and vintage filter selector carousel.
 */

function drawBevel(ctx, x, y, w, h, sunken = false) {
...
export const instagram95Template = {
  ...
  render(ctx, img, bounds, state) {
    ...
    const barH = 170;
    drawBevel(ctx, pvX, barY, pvW, barH, true);
    ctx.fillStyle = '#b0b0b0';
    ctx.fillRect(pvX + 3, barY + 3, pvW - 6, barH - 6);
